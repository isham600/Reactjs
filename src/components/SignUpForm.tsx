        ...
        >
            ...
            <div className="flex flex-col gap-2 xs:gap-4 xs:flex-row">
                <label className="flex flex-col mt-4">
                    ...
                    <input
                        ...
                        className="rounded-lg px-2 py-[2px] text-black outline-none"
                    />
                </label>
                ...
                <div className="relative">
                    <label className="flex flex-col mt-2">
                        ...
                        <img
                            ...
                            height={20}
                            alt="eye-icon"
                            className="absolute cursor-pointer right-2 bottom-1"
            ...
            <div className="flex justify-evenly">
                <a
                    ...
                    className="flex items-center justify-center gap-2 px-3 py-1 text-black bg-white rounded-3xl"
                >
                    <img
                        src="svg/gmail.svg"
                        width={16}
